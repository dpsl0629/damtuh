...
<div class="id" style="display: none;">${currentUserName}</div>
        ...
        <input type="checkbox" id="all-check"> <label for="all-check" style="font-weight: 600; color: #000; margin-left: 10px; font-size: 15px;">담터의 모든 약관을 확인 하고 전체 동의 합니다. (전체 동의에 선택항목도 포함됩니다.)</label>
            <div class="agree-box">
                ...
                그 밖의 사항은 (주) 담터의 개인정보처리방침을 준수합니다.
                </div>
            ...
            표준약관 제10023호
            <br>
            이 약관은 주식회사 담터가 운영하는 사이트(www.damtuh.co.kr 이하 "담터)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
