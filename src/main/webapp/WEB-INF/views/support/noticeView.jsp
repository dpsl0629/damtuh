	...
	<div class="contents-box notice-box">
		<div class="board-view opt-clearfix">
			<div class="board-view-header">
				<p class="tit">
					<span class="opt-screen-out">공지</span>
					<span class="ico-badge badge-region">
				...
				<c:when test="${attachList != null}">
					<c:forEach items="${attachList}" var="attach">
						<div class="board-view-file">
							<div class="file-lst">
								<p class="file">
									<a href="#lnk" data-path="${attach.uploadPath }"
										data-uuid="${attach.uuid }"
										data-filename="${attach.fileName }"> <img class="ico"
										src="${contextPath }/resources/images/sub/attach.png" />
			...
			<div class="board-view-con">${article.content }</div>
			...
			<form id="oper-form" method="get">
				...
				<input type="hidden" id="bno" name="bno"
					value="<c:out value='${article.bno }'/>"> <input
				...
				$(".file a").on(
						...
						function(e) {
							...
							var path = encodeURIComponent(liObj.data("path")
									+ "/" + liObj.data("uuid") + "_"
									+ liObj.data("filename"));
							self.location = "/support/download?fileName="
									+ path;
						});
