...
<div class="contents">
	<div class="join-box">
		<form id="modify-confirm"
			action="${contextPath }/member/modifyConfirm" class="join-form">
			<fieldset>
				<legend>회원가입</legend>
				<div class="join-cont">
					<div class="input-field">
						...
						<div class="input-box">
							<input type="text" value="${memberVO.name}" class="name disabled"
								name="name" placeholder="이름" readonly>
						</div>
					</div>
					<div class="input-field">
						<div class="input-tit">
						...
						<div class="input-box">
							<div class="input-col">
								<input type="text" class="disabled" name="id" placeholder="아이디"
					...
					<div class="input-field  input-phone">
						...
						<div class="input-box">
							<div class="input-col">
								<input type="text" value="${memberVO.birth }"
									class="datepicker-here disabled" data-position="right top"
									name="birth" readonly>
							</div>
						</div>
					</div>
					...
					<div class="input-field input-button input-address">
						...
						<div class="address-etc">
							<input type="text" name="address1" id="sample6_address"
								value="${memberVO.address1 }" placeholder="주소1"> <input
								type="text" name="address2" id="sample6_detailAddress"
								value="${memberVO.address2 }" placeholder="나머지 주소">
						</div>
					</div>
				</div>
