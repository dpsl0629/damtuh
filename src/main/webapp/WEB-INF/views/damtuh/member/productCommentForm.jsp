	...
	<div class="myPage-box comment-box opt-clearfix">
		...
		<div class="cont-container">
			<form id="comment-form"
				action="${contextPath }/member/commentConfirm">
				<div class="txt-box">
					<p class="tit">
						구매하신 상품 잘받으셨나요?<br> <span class="desc">상품평을 남겨주시면 다른
							분들께 도움이 됩니다!</span>
					</p>
				</div>
				<div class="desc-box">
					...
					<div class="like-box">
						<p class="tit">상품은 어떠셨나요? 별점을 매겨주세요!</p>
						<div>
							<a href="#lnk" class="like like1"></a> <a href="#lnk"
								class="like like2"></a> <a href="#lnk" class="like like3"></a> <a
								href="#lnk" class="like like4"></a> <a href="#lnk"
								class="like like5"></a>
						</div>
					</div>
